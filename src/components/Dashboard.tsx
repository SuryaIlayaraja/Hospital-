        ...
        >
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-4">
              <button
                onClick={() => onNavigate?.("opd")}
                className="group flex items-center justify-center gap-3 px-8 py-4 sm:px-10 sm:py-5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-bold text-base sm:text-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-blue-500/20"
              >
              ...
              <button
                onClick={() => onNavigate?.("ipd")}
                className="flex items-center justify-center gap-3 px-8 py-4 sm:px-10 sm:py-5 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-xl font-bold text-base sm:text-lg hover:from-pink-600 hover:to-rose-600 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-pink-500/20"
              >
