...
const LoginShapes: React.FC<LoginShapesProps> = ({ focusedInput, emailLength }) => {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full flex items-center justify-center bg-[#f4f4f5] dark:bg-[#080808] overflow-hidden rounded-l-[2rem]">
      {/* Background Decor */}
      <div className="absolute top-10 left-10 w-24 h-24 rounded-full bg-blue-200 dark:bg-blue-900/20 opacity-50 blur-xl animate-pulse" />
      <div className="absolute bottom-20 right-20 w-32 h-32 rounded-full bg-orange-200 dark:bg-orange-900/20 opacity-50 blur-xl animate-bounce duration-[3000ms]" />
      ...
      <div className="absolute top-8 right-8 text-black/10 dark:text-white/5 font-bold text-xs tracking-widest uppercase">
